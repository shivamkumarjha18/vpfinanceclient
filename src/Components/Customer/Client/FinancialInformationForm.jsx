...
//   // Safely access Redux state with default value
...
//       try {
//         if (!clientId) return; // Avoid fetch if clientId is not available
...
//         if (onClientCreated && clientIdFromRedux) {
//           onClientCreated(clientIdFromRedux);
//         }
//       } else {
//         toast.error("Failed to add financial information.");
//       }
//     } catch (error) {
//       console.error("Error submitting financial data:", error);
//       toast.error("Failed to add financial information. Please try again.");
//     }
//   };
