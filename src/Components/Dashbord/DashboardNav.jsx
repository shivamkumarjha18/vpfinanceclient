            ...
            <Nav className="mx-auto">
              ...
              <Dropdown as={Nav.Item} className="nav-item dropdown-hover">
                <Dropdown.Toggle as={Nav.Link} className="nav-link">
                  ...
                  <span className="nav-text">
                    Masters <FiChevronDown size={12} className="ms-1 dropdown-chevron" />
                  </span>
                </Dropdown.Toggle>
              ...
              <Dropdown as={Nav.Item} className="nav-item dropdown-hover">
                <Dropdown.Toggle as={Nav.Link} className="nav-link">
                  ...
                  <span className="nav-text">
                    Customers <FiChevronDown size={12} className="ms-1 dropdown-chevron" />
                  </span>
                </Dropdown.Toggle>
                <Dropdown.Menu className="p-3" style={{ minWidth: '400px' }}>
                  <div className="row">
              ...
              <Dropdown as={Nav.Item} className="nav-item dropdown-hover">
                <Dropdown.Toggle as={Nav.Link} className="nav-link">
                  ...
                  <span className="nav-text">
                    Employee <FiChevronDown size={12} className="ms-1 dropdown-chevron" />
                  </span>
                </Dropdown.Toggle>
                <Dropdown.Menu className="p-3" style={{ minWidth: '400px' }}>
                  <div className="row">
              ...
              <Dropdown as={Nav.Item} className="nav-item dropdown-hover">
                <Dropdown.Toggle as={Nav.Link} className="nav-link">
                  ...
                  <span className="nav-text">
                    CRM <FiChevronDown size={12} className="ms-1 dropdown-chevron" />
                  </span>
                </Dropdown.Toggle>
                <Dropdown.Menu className="p-3" style={{ minWidth: '400px' }}>
                  <div className="row">
              ...
              <Dropdown as={Nav.Item} className="nav-item dropdown-hover">
                <Dropdown.Toggle as={Nav.Link} className="nav-link">
                  ...
                  <span className="nav-text">
                    Reports <FiChevronDown size={12} className="ms-1 dropdown-chevron" />
                  </span>
                </Dropdown.Toggle>
                <Dropdown.Menu className="p-3" style={{ minWidth: '400px' }}>
                  <div className="row">
